...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dockWidgetFiles = QtGui.QDockWidget(MainWindow)
        self.dockWidgetFiles.setObjectName(_fromUtf8("dockWidgetFiles"))
        self.dockWidgetContents = QtGui.QWidget()
        self.dockWidgetContents.setObjectName(_fromUtf8("dockWidgetContents"))
        self.gridLayout_2 = QtGui.QGridLayout(self.dockWidgetContents)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.fsTree = FileSystemTreeView(self.dockWidgetContents)
        self.fsTree.setObjectName(_fromUtf8("fsTree"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dockWidgetFiles.setWindowTitle(_translate("MainWindow", "Files", None))
